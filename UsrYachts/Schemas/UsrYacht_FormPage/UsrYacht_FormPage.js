define("UsrYacht_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "MultiSelect_w8ei4f6",
				"values": {
					"type": "crt.MultiSelect",
					"label": "#ResourceString(MultiSelect_w8ei4f6_label)#",
					"recordId": "$Id",
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"MultiSelect_w8ei4f6_List_Items_Predefined_Filter": {
						"value": null
					}
				}
			},
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_mpj2w0n;
