namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageTicketPriceProcessUsrYachts1MethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageTicketPriceProcessUsrYachts1MethodsWrapper : ProcessModel
	{

		public UsrCalcAverageTicketPriceProcessUsrYachts1MethodsWrapper(Process process)
			: base(process) {
